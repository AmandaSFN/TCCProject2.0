class DataProcessing:
    ...
    data = ['storm', 'snow', 'hail',
            'rain', 'fog', 'clear_day', 'clear_night', 'cloud',
            'cloudly_day', 'cloudly_night', 'none_day',
            'none_night', 'Current Umidity']
    ...
    def SaveProcessedData(file, value):
        return file.AddInputedDataWithItsResult(
            DataProcessing.forecastValues, value
        )
